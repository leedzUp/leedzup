                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <ul class="list-unstyled"><li>
                                    <a class="title-mobile" href="/fr/nos-biens-2.htm" class="text-decoration-none">
                                    Nos biens
                                    </a><li><li>
                                    <a class="title-mobile" href="/fr/blog" class="text-decoration-none">
                                    Actualité
                                    </a><li><li>
                                    <a class="title-mobile" href="/fr/contact" class="text-decoration-none">
                                    Nous contacter
                                    </a><li>
                        <li>User icon</li>
                            </ul>
