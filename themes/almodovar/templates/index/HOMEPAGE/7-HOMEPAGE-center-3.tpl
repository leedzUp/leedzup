<div class="mt-5 container"><h2 class="{if Context::getContext()->detectDeviceByUserAgent() == "mobile"}text-center{/if} title mb-2">Your new home in Alicante</h2><div class="row"><div class="{if Context::getContext()->detectDeviceByUserAgent() == "mobile"}px-4{/if} col-md-6 card"><div class="shadow rounded-5 card-body d-flex row"><div class="p-3 col-12  col-md-4"><a href="https://test.leedzup.com/gb/real-estate-house-flat-near-the-sea-10.htm"><img src="https://test.leedzup.com/img/c/10.webp" alt="Real estate house / flat near the sea" class="rounded-5 mb-4 img-fluid"><h2 class="text-center">Flat Near The Sea</h2></a></div><div class="p-3 col-6 col-md-4"><a href="https://test.leedzup.com/gb/real-estate-house-flat-on-golf-course-20.htm"><img src="https://test.leedzup.com/img/c/20.webp" alt="Real estate house / flat on golf course" class="rounded-5 mb-4 img-fluid"><h2 class="text-center">Flat On Golf Course</h2></a></div><div class="p-3 col-6 col-md-4"><a href="https://test.leedzup.com/gb/real-estate-in-alacant-alicante-15.htm"><img src="https://test.leedzup.com/img/c/15.webp" alt="Real estate in Alacant / Alicante" class="rounded-5 mb-4 img-fluid"><h2 class="text-center">Alicante</h2></a></div></div><div class="d-flex align-items-center justify-content-between mt-5 mb-5"><div class="fs-4 fw-bold"><p><span>Need to be contacted?</span></p></div><div class="w-100 d-flex justify-content-end"><span data-bs-toggle="modal" data-bs-target="#leadFormModalHome" class="fw-bold btn btn-primary fs-5 text-white rounded-pill">I have a project</span></div></div></div><div class="col-md-6"><div id="map" style="height: 400px;">ici une carte</div></div></div></div><link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" />
...
<p class="mt-4"><span class="fw-bold btn btn-primary fs-5 text-white rounded-pill">Get an assessment</span></p></div>{/if}</div></div></div></div><div id="target-6" class=" container mt-2 xs-mt-2">
      <div class="row">
          <div class="pl-4 col-md-12 mt-4">
              <h2 class="title {if Context::getContext()->detectDeviceByUserAgent() == "mobile"}text-center{/if}">Our Real Estate Guides</h2> {if Context::getContext()->detectDeviceByUserAgent() != "mobile"}<div class="mw-540"><p>All our advice to help you make the most of your property projects in Alicante.</p></div>{/if}{if Context::getContext()->detectDeviceByUserAgent() != "mobile"}<div class="mt-4 xs-mt-4"><a href="en/category/our-real-estate-guides-3" class="fw-bold btn btn-primary fs-5 text-white rounded-pill">See our guides</a></div>{/if}<div class="mt-6 row"></div>{if Context::getContext()->detectDeviceByUserAgent() == "mobile"}<div class="text-center mt-4 xs-mt-4"><a href="en/category/our-real-estate-guides-3" class="fw-bold btn btn-primary fs-5 text-white rounded-pill">See our guides</a></div>{/if}</div>
          </div>
